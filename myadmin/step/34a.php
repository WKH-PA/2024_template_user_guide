  ...
  <table class="table table-hover table-danhsach">
    <tbody>
      <tr>
        ...
        <?php } ?>
        <th class="w150 text-center">Mủ nước</th>
        <th class="w150 text-center">Mủ tạp</th>
        <th class="w100 text-center">Ngày</th>
      ...
      <tr>
        ...
        <?php } ?>
        <td class="text-center"><?=$thuoc_tinh_1_vi ?></td>
        <td class="text-center"><?=$thuoc_tinh_2_vi ?></td>
        <td class="text-center"><?=date('d/m/Y', $capnhat) ?></td>
        <?php if(in_array($step, $st_nhom_opt)){ ?>
        <td class="text-center">
