...
<div class="box p10">
  ...
  <div class="form-group">
    <label>Mủ tạp</label>
    <input type="text" class="form-control" value="<?=!empty($thuoc_tinh_2_vi) ? SHOW_text($thuoc_tinh_2_vi) : ''?>" name="thuoc_tinh_2_vi" id="thuoc_tinh_2_vi">
  </div>
  <div class="form-group" style="display:none">
  ...
  <div class="form-group">
    <label>Bảng giá ngày</label>
    <div class="input-group date">
      <div class="input-group-addon">
        <i class="fa fa-calendar"></i>
      </div>
      <input name="capnhat" type="text" class="form-control pull-right datepicker" id="datepicker2" value='<?=$capnhat?>'>
    </div>
  </div>
  <div class="form-group">
