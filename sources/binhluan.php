          ...
          <div class="boxComment_danhgia">
            <form action="" method="post">
              ...
              <div class="col-md-3 row-frm">
                <input type="text" name="tenbinhluan_bl" class="js_check_null_1 form-control_3" placeholder="<?=$glo_lang['tieu_de'] ?>">
              </div>
              <li><?=$glo_lang['viet_nhan_xet'] ?> (*):</li>
              <div class="col-md-3 row-frm">
                <textarea name="noidung_bl" class="form-control_3 js_check_null_2" style="height:80px; padding-top:15px;" placeholder="<?=$glo_lang['viet_danh_gia'] ?>"></textarea>
                <h4>
