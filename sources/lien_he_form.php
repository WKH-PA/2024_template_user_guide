...
<div class="page_conten_page pagewrap">
    <div class="left_contact">
        ...
        ?>
        <p><strong><a href="<?= $full_url ?>"><h2><?= SHOW_text($noidung['tenbaiviet_' . $lang]) ?></h2></a></strong></p>
        ...
        $image_url = full_src($noidung, '');
        ?>
        <p><strong><a href="<?= $full_url ?>"></a></strong></p>
        <?= SHOW_text($noidung['noidung_' . $lang]) ?>
    </div>
    ...
    <div class="right_contact">
        ...
        <form action="" class="formBox no_box" method="post" accept-charset="UTF-8" name="formnamecontact2" id="formnamecontact2">
            ...
            <div class="right_contact">
                <!-- More input fields for contact information -->
                <li class="local">
